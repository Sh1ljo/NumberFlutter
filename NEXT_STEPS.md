...
- [ ] Factory reset while signed in (Settings): the tutorial starts again,
      your All-Time leaderboard score drops to zero, and after a restart
      nothing comes back from the cloud. The same deploy lets the reset
      delete your archived prestige runs.
